...
#
# """
# indent - отступ в нашем файле(если убрать, все данные будут записаны в одну строку)
# ensure_ascii - помогает в работе с кириллицей,
# """
#
...
for category_name, category_href in all_categories.items():
    ...
    # проверяем страницы на наличие таблиц с продуктами
